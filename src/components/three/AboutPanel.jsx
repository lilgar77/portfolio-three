...
export function AboutProfilCard() {
  return (
    <div className="w-64 max-w-full rounded-2xl border border-sky-400/60 bg-slate-950/95 px-4.5 py-3 text-[0.75rem] text-sky-50 shadow-xl backdrop-blur-lg">
...
export function AboutFormationCard() {
  return (
    <div className="w-64 max-w-full rounded-2xl border border-sky-500/50 bg-slate-950/95 px-4.5 py-3 text-[0.75rem] text-sky-50 shadow-xl backdrop-blur-lg">
      ...
      <div className="text-[0.7rem] text-slate-200/95 space-y-0.5">
        <div className="pt-1">
          ...
          <p className="text-[0.65rem] text-slate-300">2026 - 2028</p>
        </div>
        <div>
        ...
        <div className="pt-1">
          ...
          <p className="text-[0.65rem] text-slate-300">Option Systèmes d&apos;Information et Numérique (SIN) · 2022</p>
        </div>
      </div>
    </div>
  )
...
export function AboutExperiencesCard() {
  return (
    <div className="w-68 max-w-full rounded-2xl border border-sky-500/50 bg-slate-950/95 px-4.5 py-3 text-[0.75rem] text-sky-50 shadow-xl backdrop-blur-lg">
      <p className="mb-1 text-[0.7rem] font-semibold uppercase tracking-[0.26em] text-sky-300/80">Expériences</p>
      <div className="text-[0.7rem] text-slate-200/95 space-y-1">
        <div>
...
export function AboutLanguesSoftSkillsCard() {
  return (
    <div className="w-60 max-w-full rounded-2xl border border-slate-500/50 bg-slate-950/95 px-4 py-2.5 text-[0.75rem] text-sky-50 shadow-xl backdrop-blur-lg">
      <p className="mb-1 text-[0.7rem] font-semibold uppercase tracking-[0.26em] text-sky-300/80">Langues</p>
      <ul className="text-[0.7rem] text-slate-200/95 space-y-0.5">
      ...
      <div className="mt-1 flex flex-wrap gap-1.5">
        {['Travail en équipe', 'À l’écoute', 'Autonome', 'Sociable'].map((item) => (
          <span
            key={item}
            className="rounded-full bg-slate-900/90 px-2 py-0.5 text-[0.6rem] font-medium text-sky-100 border border-slate-500/40"
          >
            {item}
          </span>
        ))}
